...
class BookContent(models.Model):
    ...
    bookcol = models.CharField(max_length=45, blank=True, null=True)
    year = models.DateField(blank=True, null=True)
    description = models.CharField(max_length=45, blank=True, null=True)
    typename = models.CharField(max_length=35, blank=True, null=True)
...
class BookOnsale(models.Model):
    idbook = models.IntegerField(primary_key=True)
    book_onsale = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'book_onsale'


class BookPicture(models.Model):
    idbook = models.ForeignKey(BookContent, models.DO_NOTHING, db_column='idbook', primary_key=True)
    picture = models.CharField(max_length=45, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'book_picture'
...
class SellerBook(models.Model):
    ...
    idbook = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'seller_book'
